...
def torch_pose_obj_data(batch_size=1):
    ...
    """
    body25_reg = pkl.load(open('body_models/misc/body25_regressor.pkl', 'rb'), encoding="latin1").T
    face_reg = pkl.load(open('body_models/misc/face_regressor.pkl', 'rb'), encoding="latin1").T
    hand_reg = pkl.load(open('body_models/misc/hand_regressor.pkl', 'rb'), encoding="latin1").T
