...
class SMPL_Layer(Module):
    ...
    def __init__(self,
        ...
        if gender == 'neutral':
            ...
            self.model_path = os.path.join(model_root, gender, 'neutral_model.pkl')
        elif gender == 'female':
            # self.model_path = os.path.join(model_root, 'basicModel_f_lbs_10_207_0_v1.0.0.pkl')
            self.model_path = os.path.join(model_root, gender, 'female_model.pkl')
        elif gender == 'male':
            # self.model_path = os.path.join(model_root, 'basicModel_m_lbs_10_207_0_v1.0.0.pkl')
            self.model_path = os.path.join(model_root, gender, 'male_model.pkl')
